...
public interface StoreService {
    //매장 등록 서비스
    StoreDto.RegistedStoreInfo registStore(User user, StoreDto.RegistRequest request);
    ...
    //매장 상세정보 등록 서비스
    StoreDetailDto.RegistedStoreDetails registStoreDetail(User user, Long storeId, List<StoreDetailDto.RegistRequest> requests);
